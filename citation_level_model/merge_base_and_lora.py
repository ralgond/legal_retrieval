...
tokenizer = AutoTokenizer.from_pretrained("../ft_data/group-style-reranker-lora/adapter")
base = AutoModelForSequenceClassification.from_pretrained(
    "/root/.cache/modelscope/hub/models/BAAI/bge-reranker-v2-m3", num_labels=1
)
# model = PeftModel.from_pretrained(base, "../ft_data/lora_reranker_output")
model = PeftModel.from_pretrained(base, "../ft_data/group-style-reranker-lora/adapter")
merged = model.merge_and_unload()
