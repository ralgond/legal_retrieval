...
tokenizer = AutoTokenizer.from_pretrained("../ft_data/reranker-lora-output/best_adapter")
...
model = PeftModel.from_pretrained(base, "../ft_data/reranker-lora-output/best_adapter")
