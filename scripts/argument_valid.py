...
for query_id, query_en in tqdm(zip(test_df['query_id'].tolist(), test_df['query'].tolist()), total=len(test_df)):
...
new_test_df.to_csv("../data/valid_rewrite_002.csv", index=False)
