...
with open("../data/ml5_1000/raw_valid_candidate.pkl", "wb+") as of:
    pickle.dump(valid_l, of)
    
train_l = generate_dataset(train_df, 'query2')
with open("../data/ml5_1000/raw_train_candidate.pkl", "wb+") as of:
    pickle.dump(train_l, of)
    
test_l = generate_dataset(test_df, 'query')
with open("../data/ml5_1000/raw_test_candidate.pkl", "wb+") as of:
