...
from pipeline_common import Citation, extract_features_for_query

def build_split(df: pd.DataFrame, split_name: str, candidate_d, 
    ...
    for i, (query_id, query, gold_citations) in enumerate(
        ...
        cid_feat_d = extract_features_for_query(query_id, query, candidate_d, gold_set)
...
if __name__ == "__main__":
    ...
    build_split(train_df, "train", train_candidate_d,
                min_pos_in_candidate=args.min_pos,
                only_filter_train=not args.filter_valid,
                neg_pos_ratio=args.neg_pos_ratio,)
    build_split(valid_df, "valid", valid_candidate_d,
                min_pos_in_candidate=args.min_pos,
                only_filter_train=not args.filter_valid,
                neg_pos_ratio=args.neg_pos_ratio)
